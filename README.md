...
2. [Baisc usage](#basic-usage)
	1. [Configure the seng generator](#step-1:-configure-the-seng-generator)
		1. [Updating the template path](#updating-the-template-path)
	2. [Generating a page](#step-2:generating-a-page)
	3. [Creating a wildcard route](#step-3:-creating-a-wildcard-route)
	4. [Enable the plugin](#step-4:-enable-the-plugin)
		1. [Store](#store)
		2. [Block](#block)
		3. [Config](#config)
			1. [API Configuration](#api-configuration)
			2. [Debug label configuration](#debug-label-configuration)
	5. [Creating a block](#step-5:-creating-a-block)
